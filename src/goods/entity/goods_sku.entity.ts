 ...
 * @LastEditTime : 2020-02-04 20:35:03
...
export class goods_sku {
    ...
    @JoinTable({ name: 'goods_sku_spec_value', joinColumn: { name: "sku_id", referencedColumnName: "id" }, inverseJoinColumn: { name: "spec_value_id", referencedColumnName: "id" } }) // 设置中间表
