 ...
 * @LastEditTime: 2020-02-18 10:37:15
...
export class goods_spu {
    ...
    @OneToMany(type => goods_spu_preview, goods_spu_preview => goods_spu_preview.spu)
    preview: goods_spu_preview[];

    @OneToMany(type => goods_spu_content, goods_spu_content => goods_spu_content.spu)
    content: goods_spu_content[];
